...
diag_dom = int(input("Enter the condition: 0 for diagonally dominant, 1 for diagonally non-dominant: "))

if diag_dom == 0:
	c = gen_diag_dom(size)
elif diag_dom == 1:
	c = gen_diag_non_dom(size)
